...
export function startBrowserTranscription(onText:(text:string)=>void,onError:(message:string)=>void,lang="en-US"):SpeechController|null{
 ...
 const recognition=new SpeechRecognition();recognition.lang=lang;recognition.interimResults=false;recognition.continuous=false;recognition.onresult=e=>onText(e.results[e.resultIndex][0].transcript);recognition.onerror=()=>onError('Unable to transcribe. You can type or edit your answer instead.');recognition.start();return {stop:()=>recognition.stop()};
}
