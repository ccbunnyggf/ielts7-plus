import { analyseReadingImagesWithVision, isVisionConfigured, type ReadingVisionImage } from "../../readingVisionService";
...
export async function POST(request: Request) {
  ...
  const result = await analyseReadingImagesWithVision({ articleId: payload.articleId, contentHash: payload.contentHash, images: payload.images });
